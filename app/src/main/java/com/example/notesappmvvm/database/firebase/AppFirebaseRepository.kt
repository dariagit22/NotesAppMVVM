...
class AppFirebaseRepository : DatabaseRepository {
    ...
    override suspend fun create(note: Note, onSuccess: () -> Unit) {
        ...
        database.child(noteId)
            ...
            .addOnFailureListener { Log.d("checkDate", "Failed to add a new note")}
    }
    ...
    override suspend fun update(note: Note, onSuccess: () -> Unit) {
        ...
        database.child(noteId)
            .updateChildren(mapNotes)
            .addOnSuccessListener { onSuccess() }
            .addOnFailureListener { Log.d("CheckDate", "Failed to update note") }
    ...
    override suspend fun delete(note: Note, onSuccess: () -> Unit) {
        database.child(note.firebaseId)
            .removeValue()
            .addOnSuccessListener { onSuccess() }
            .addOnFailureListener { Log.d("CheckDate", "Failed to delete note") }
    }
